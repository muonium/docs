...
@apiParam 								{Int[]} 	files					Array of files ID from old_folder to move (they must not be in the trash).
@apiParam 								{Int[]} 	folders					Array of folders ID from old_folder to move (they must not be in the trash).
