...
@apiSuccess (Success 200 - doubleAuthGA)	{String} message	"doubleAuthGA". 2-factor authentication is enabled, credentials are valid but you need to send them again with code generated by Google Authenticator.
@apiSuccess (Success 200 - doubleAuthGA) 	{Object} data
@apiSuccess (Success 200 - doubleAuthGA) 	{String} data.cek	CEK.
@apiSuccess (Success 200 - doubleAuthGA) 	{Int}    data.uid	UID.
